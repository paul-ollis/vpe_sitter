"""VPE-sitter installation script for Linux and Windows"""
...
def main(args: argparse.Namespace) -> None:
    ...
    # Install VPE-sitter, which will pull in the dependencies.
    print('Installing VPE-Sitter and dependencies...')
    if not run_command(pip_base + ['--upgrade', 'vpe-sitter']):
        sys.exit(1)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Install VPE-sitter and dependencies.')
    parser.add_argument(
